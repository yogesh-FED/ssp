...
const SchemeRegistration = () => {
  ...
  const initialFormData = {
    ...
    residentalStatus: [], disabilityStatus: [], disabilityCategory: [], schemeFeeType: [], instituteOwnership: [], inex: [],
  };
  ...
  const [answer, setAnswer] = useState(null); //radio button
  ...
  const handleOptionsChange = async (e, name) => {
    debugger;
    if (name === 'university') {
  ...
  const handleHideShow = (event) => {
    ...
    setShowInput(event.target.value === 'show'); // Show input only for 'show' value
  };
  ...
  const saveFormData = () => {
    // You can send jsonData to a server or perform other actions with it
    const data = {
      department: formData.department,
      subDepartment: formData.subDepartment,
      schemeName: formData.schemeName,
      schemeCode: formData.schemeCode,
      schemeFeeType: formData.schemeFeeType,
    }
    alert("Data" + JSON.stringify(data.department))
    var schemeDetails = [];
    schemeDetails = data;
    setSchemeDetails(data);
    alert("scheme" + JSON.stringify(schemeDetails));
  };
            ...
            <div class="tab-content my-3" id="myTabContent">
              <div className={`tab-pane fade ${active === 'home-tab-pane' ? 'show active' : ''}`} id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                <form className="row">
                    ...
                    <div class="row">
                      ...
                      <div className="col-md-4 mb-2 form-group">
                        ...
                        <Select
                          //defaultValue={selectedOptions}
                          //isMulti
                          options={[{ value: 'Fixed', label: 'Fixed' }, { value: 'Component Based', label: 'Component Based' },
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <select className="form-select" name="InstituteCategory" onChange={(e) => handleINEX(e, 'inex')}>
                          <option value="">Select Scheme</option>
                          <option value="1" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Inclusive </option>
                          <option value="2" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Exclusive</option>
                        </select>
                      </div>
                      {
                        showINEX && (
                  ...
                  <div className="col-md-4 mb-2">
                    <label for="inputEmail4" className="form-label lbl-font w-100 lbl-color">Max Slab</label>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio1"
                        value="show" name="visibility" onChange={handleHideShow} checked={selectedValue === 'show'}
                      />
                      <label class="form-check-label" for="inlineRadio1">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                        value="hide" name="visibility" onChange={handleHideShow} checked={selectedValue === 'hide'} />
                      <label class="form-check-label" for="inlineRadio2">No</label>
                    </div>
                  </div>
                  ...
                  <div className='separateComp row'>
                    ...
                    <div className="col-md-4 mb-2">
                      <label for="inputEmail4" className="form-label lbl-font lbl-color">Accrediation Status</label>
                      {/* <input type="number" className="form-control removespecialchar" placeholder="Enter Max Slab" /> */}
